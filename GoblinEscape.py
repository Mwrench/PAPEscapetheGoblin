...
def clear():
    ...
    window.fill((99, 235, 101))
    pygame.draw.circle(window, (0, 255, 238), (int(width / 2), int(height / 2)), int(radius * 1.00), 0)
    pygame.draw.circle(window, (0, 0, 0), (int(width / 2), int(height / 2)), int(radius * 1.00), 5)
    pygame.draw.circle(window, (200, 200, 200), (int(width / 2), int(height / 2)), int(radius * radius_mult), 6)
    pygame.draw.circle(window, (200, 0, 200), (int(width / 2), int(height / 2)), int(radius * radius_mult), 5)


def redraw(draw_text=False, win=False):
    clear()

    pygame.draw.circle(window, (2, 125, 4),
                       (int(width / 2 + boatx), int(height / 2 + boaty)), 16, 9)
    pygame.draw.circle(window, (255, 0, 0),
                       (int(width / 2 + radius * math.cos(goblin)), int(height / 2 + radius * math.sin(goblin))), 16, 0)
